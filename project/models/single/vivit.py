...
# -*- coding:utf-8 -*-
"""
File: /workspace/code/project/models/single/vivit.py
Project: /workspace/code/project/models/single
...
-----
Last Modified: Wednesday June 18th 2025 8:27:36 pm
    ...
    def forward(self, video):
        ...
        if self.variant == "factorized_encoder":
            ...
            x = (
                x[:, 0, 0]
                if not self.global_average_pool
                else reduce(x, "b f n d -> b d", "mean")
            )
...
if __name__ == "__main__":
    ...
    print(preds.shape)  # Should be (4, 1000)
